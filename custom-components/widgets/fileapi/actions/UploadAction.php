...
namespace custom_components\widgets\fileapi\actions;

use custom_components\widgets\fileapi\Widget;
use yii\base\Action;
 ...
 *     return [
 *         'upload' => [
 *             'class' => 'custom_components\widgets\fileapi\actions\UploadAction',
 *             'path' => '@path/to/files',
