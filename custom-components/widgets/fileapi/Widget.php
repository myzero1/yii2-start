 ...
 * ```
 * ...
 * echo \custom_components\widgets\fileapi\Widget::widget([
 *     'name' => 'fileapi',
 *     'settings' => [
 *         'autoUpload' => true
 *     ]
 ...
 * ```
 * ...
 * echo $form->field($model, 'file')->widget('custom_components\widgets\fileapi\Widget', [
 *     'settings' => [
 *         'autoUpload' => true
 *     ]
 * ]);
...
class Widget extends InputWidget
{
    ...
    {
        return Yii::t('custom_components/widgets/' . $category, $message, $params, $language);
    }
    ...
    {
        if (!isset(Yii::$app->i18n->translations['custom_components/widgets/fileapi']) && !isset(Yii::$app->i18n->translations['custom_components/widgets/*'])) {
            Yii::$app->i18n->translations['custom_components/widgets/fileapi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@custom_components/widgets/fileapi/messages',
                'fileMap' => [
                    'custom_components/widgets/fileapi' => 'fileapi.php'
                ],
