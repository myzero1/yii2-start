...
namespace custom_components\modules\users\controllers\backend;

use custom_components\modules\admin\components\Controller;
use custom_components\widgets\fileapi\actions\UploadAction as FileAPIUpload;
use custom_components\modules\users\models\backend\User;
use custom_components\modules\users\models\backend\UserSearch;
...
class DefaultController extends Controller
{
     ...
     *
     * @return \custom_components\modules\users\models\backend\User User
