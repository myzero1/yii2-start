...
class Module extends \yii\base\Module
{
    ...
    public $controllerNamespace = 'custom_components\modules\users\controllers\frontend';
...
// var_dump('expression');exit;
        ...
        if ($this->isBackend === true) {
            $this->setViewPath('@custom_components/modules/users/views/backend');
        } else {
            $this->setViewPath('@custom_components/modules/users/views/frontend');
        }
    }
    ...
    public function getMail()
    {
        if ($this->_mail === null) {
            ...
            $this->_mail->htmlLayout = '@custom_components/modules/users/mails/layouts/html';
            $this->_mail->textLayout = '@custom_components/modules/users/mails/layouts/text';
            $this->_mail->viewPath = '@custom_components/modules/users/mails/views';
    ...
    {
        return Yii::t('custom_components/modules/' . $category, $message, $params, $language);
    }
}
