...
namespace custom_components\modules\users\models\backend;
...
/**
 * Class User
 * @package custom_components\modules\users\models\backend
 ...
 */
class User extends \custom_components\modules\users\models\User
{
    /**
