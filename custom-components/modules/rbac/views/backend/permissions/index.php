...
use custom_components\themes\admin\widgets\GridView;
use custom_components\modules\rbac\Module;
use yii\grid\ActionColumn;
use yii\grid\CheckboxColumn;

$this->title = Module::t('rbac', 'BACKEND_PERMISSIONS_INDEX_TITLE');
$this->params['subtitle'] = Module::t('rbac', 'BACKEND_PERMISSIONS_INDEX_SUBTITLE');
