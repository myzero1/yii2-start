...
use custom_components\themes\admin\widgets\Menu;
...
echo Menu::widget(
    [
        ...
        /*'items' => [
            ...
            [
                'label' => Yii::t('custom_components/themes/admin', 'Blogs'),
                'url' => ['/blogs/default/index'],
                'icon' => 'fa-book',
                'visible' => Yii::$app->user->can('administrateBlogs') || Yii::$app->user->can('BViewBlogs'),
            ],
            [
                'label' => Yii::t('custom_components/themes/admin', 'Comments'),
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('custom_components/themes/admin', 'Models management'),
